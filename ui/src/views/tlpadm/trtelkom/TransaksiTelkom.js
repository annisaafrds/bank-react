...
import ListTransaksiTelkom from './ListTransaksiTelkom';
...
class TransaksiTelkom extends Component {
  ...
  listPegawaiDb(field, value, page, size) {
    ...
    fetch(`${url}/api/transaksi-telkom/`)
      ...
      .then((Emp) => {
        ...
        this.setState(
          (prevState) => ({
            listTransaksiTelkom: Emp.data.data,
          }),
          () => {
            this.setState(
              (prevState) => ({
  ...
  render() {
    ...
    return (
      <div className="App">
        <label><strong>Data Transaksi Telkom</strong></label><br />
        <div>
        ...
        <div>
          <ListTransaksiTelkom
            listTransaksiTelkom={this.state.listTransaksiTelkom}
...
//   return {
//     dispatchListPegawai: (listTransaksiTelkom) =>
//       dispatch({ type: "UBAH_LIST_PEGAWAI", newValue: listTransaksiTelkom }),
